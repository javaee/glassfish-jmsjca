 ...
 */
/*
 * $RCSfile: XLocalTransaction.java,v $
 * $Revision: 1.3 $
 * $Date: 2007-01-21 17:51:49 $
 *
...
public class XLocalTransaction implements javax.resource.spi.LocalTransaction {
    ...
    public void commit() throws ResourceException {
        try {
            ...
            throw Exc.rsrcExc("Failed to commit local transaction: " + ex, ex);
        }
    }
    ...
    public void rollback() throws ResourceException {
        try {
            ...
            throw Exc.rsrcExc("Failed to rollback local transaction: " + ex, ex);
        }
    }
}
