...
import com.stc.jmsjca.core.JConnectionFactoryTopicXA;
 ...
 * @version $Revision$
 */
public class UnifiedMCFTopic extends UnifiedMCFBase {
    private static Logger sLog = Logger.getLogger(UnifiedMCFTopic.class);
