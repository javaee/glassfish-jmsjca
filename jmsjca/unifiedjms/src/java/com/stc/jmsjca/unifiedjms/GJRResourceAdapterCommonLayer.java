...
/**
 * A layer in the inheritance hierarchy that adds GJR properties to the RA
 * 
 ...
 * @author fkieviet
 */
public abstract class GJRResourceAdapterCommonLayer extends RAJMSResourceAdapter implements GJRCommonCfg {
