...
/**
 * A layer in the inheritance hierarchy that adds GJR properties to the ActivationSpec.
 * 
 ...
 * @author fkieviet
 */
public abstract class GJRActivationSpecCommonLayer extends RAJMSActivationSpec implements GJRCommonCfg {
