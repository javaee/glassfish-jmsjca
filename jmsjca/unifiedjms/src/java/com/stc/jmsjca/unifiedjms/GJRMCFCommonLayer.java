...
/**
 * A layer in the inheritance hierarchy that adds GJR properties to the MCF
 * 
 ...
 * @author fkieviet
 */
public abstract class GJRMCFCommonLayer extends XManagedConnectionFactory implements GJRCommonCfg {
